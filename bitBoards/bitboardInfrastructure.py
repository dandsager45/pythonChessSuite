...
from bitboard_helpers import make_empty_uint64_bitmap, set_bit, clear_bit, \
...
class Board:
    ...
    @property
    def rank_1_bb(self):
        return np.uint64(File.hex1)

    @property
    def file_2_bb(self):
        return np.uint64(File.hex2)

    @property
    def file_3_bb(self):
        return np.uint64(File.hex3)

    @property
    def file_4_bb(self):
        return np.uint64(File.hex4)

    @property
    def file_5_bb(self):
        return np.uint64(File.hex5)

    @property
    def file_6_bb(self):
        return np.uint64(File.hex6)

    @property
    def file_7_bb(self):
        return np.uint64(File.hex7)

    @property
    def file_8_bb(self):
        return np.uint64(File.hex8)
